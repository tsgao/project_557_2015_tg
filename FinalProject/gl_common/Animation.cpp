 ...
 */
////////////////////////////////////////////////////////////////////////////////////////////////////////
/*Need to change the value in the Keyframe()!
myKeyframes[0.0] stores the position and orientation of the piece we select;
myKeyframes[1.0] stores the position of the destination we select, the orientation should remain the same as that of myKeyframes[0.0]. */
void initKeyframeAnimation(void)
{
    myKeyframes[0.0] = Keyframe(0.0, glm::vec3(0.0,0.0,0.0), angleAxis(0.0f, glm::vec3(0.0,0.0,1.0) ) );
    myKeyframes[1.0] = Keyframe(1.0, glm::vec3(0.5,0.0,0.0), angleAxis(0.57f, glm::vec3(0.0,0.0,1.0) ) );
}
////////////////////////////////////////////////////////////////////////////////////////////////////////

/*Need to delete the main here*/
int main( void )
{
    // Initialise GLFW
    if( !glfwInit() )
