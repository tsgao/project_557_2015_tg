...
uniform sampler2D texture_foreground1; //this is the texture
...
void main(void)                                                   
{
    ...
    vec4 tex_color_light1 =  texture(texture_foreground1, pass_TexCoord);
    ...
    if(texture_blend == 0)
    {
        color = 0.1 * pass_Color + (tex_color + tex_color_light + tex_color_light1)/3 ;
    }
    ...
    {
        color = (tex_color_light.g)*(tex_color.r)*tex_color_light1;
    }
    else
    {
