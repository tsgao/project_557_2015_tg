...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("./shaders/noise_map.vs", "./shaders/noise_map.fs");
    ...
    int texid = texture->loadAndCreateTextures("./textures/landscapes-219a.bmp", "./textures/texture_grass_512x512.bmp");
